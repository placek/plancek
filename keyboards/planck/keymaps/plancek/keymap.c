...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    LSFT_T(KC_SLSH), KC_Z,    KC_X,    KC_C,        KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_UP,   KC_SFTENT,
...
[_ADJUST] = LAYOUT_planck_grid(
    KC_FIND, QK_BOOT, DEBUG,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, TD(PWRSLP),
    KC_TRNS, KC_TRNS, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
